...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_FILES['file']) && isset($_FILES['course_pdf'])) {
        ...
        $video_destination =  'C:\Users\vbu88\Desktop\master-test-main\Master Best\dashbordTeacher\vedio\\' . $file_name;
        $pdf_destination = 'C:\Users\vbu88\Desktop\master-test-main\Master Best\dashbordTeacher\pdf\\' . $pdf_name;
